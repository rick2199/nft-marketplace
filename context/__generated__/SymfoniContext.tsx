...
import { NFTMarket__factory } from "./../../__generated__/factories/NFTMarket__factory";
import { NFT } from "./../../__generated__/NFT";
import { NFT__factory } from "./../../__generated__/factories/NFT__factory";
import { ERC721 } from "./../../__generated__/ERC721";
import { ERC721__factory } from "./../../__generated__/factories/ERC721__factory";
...
export const NFTMarketContext = React.createContext<SymfoniNFTMarket>(emptyContract);
export const NFTContext = React.createContext<SymfoniNFT>(emptyContract);
...
export interface SymfoniNFTMarket {
    instance?: NFTMarket;
    factory?: NFTMarket__factory;
}

export interface SymfoniNFT {
    instance?: NFT;
    factory?: NFT__factory;
}
...
export const Symfoni: React.FC<SymfoniProps> = ({
    ...
    const [NFTMarket, setNFTMarket] = useState<SymfoniNFTMarket>(emptyContract);
    const [NFT, setNFT] = useState<SymfoniNFT>(emptyContract);
    ...
    useEffect(() => {
        ...
        const doAsync = async () => {
            ...
            const finishWithContracts = (text: string) => {
                setNFTMarket(getNFTMarket(_provider, _signer))
                setNFT(getNFT(_provider, _signer))
    ...
    const getNFTMarket = (_provider: providers.Provider, _signer?: Signer) => {

        const contractAddress = "0x4DC0aC3cFB4fd41fb7323a6ef377CF7568D3311a"
        const instance = _signer ? NFTMarket__factory.connect(contractAddress, _signer) : NFTMarket__factory.connect(contractAddress, _provider)
        const contract: SymfoniNFTMarket = {
            instance: instance,
            factory: _signer ? new NFTMarket__factory(_signer) : undefined,
        }
        return contract
    }
        ;
    const getNFT = (_provider: providers.Provider, _signer?: Signer) => {

        const contractAddress = "0x27c15394CeA03F2727983c7aB5F5f7aeCd53cCa1"
        const instance = _signer ? NFT__factory.connect(contractAddress, _signer) : NFT__factory.connect(contractAddress, _provider)
        const contract: SymfoniNFT = {
            instance: instance,
            factory: _signer ? new NFT__factory(_signer) : undefined,
        }
        return contract
    }
        ;
            ...
            <ProviderContext.Provider value={[provider, setProvider]}>
                <SignerContext.Provider value={[signer, setSigner]}>
                    <CurrentAddressContext.Provider value={[currentAddress, setCurrentAddress]}>
                        <NFTMarketContext.Provider value={NFTMarket}>
