...
export default function CreateItem() {
  ...
  const [formInput, updateFormInput] = useState<IFormInput>({
    price: "",
    name: "",
    description: "",
  });
  ...
  async function createSale(url: string) {
    ...
    const contract = nft.connect(signer);
    ...
    const marketContract = nftMarket?.connect(signer);
