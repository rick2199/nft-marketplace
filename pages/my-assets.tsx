...
export default function MyAssets() {
  ...
  async function loadNFTs() {
    ...
    const marketContract = await nftMarket?.connect(signer);
    const tokenContract = await nft?.connect(signer);
    const data = marketContract ? await marketContract.fetchMyNFTs() : [];
